...
const CONTACT_EMAIL = 'bv99@cornell.edu';
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const id = window.setTimeout(() => setShowCopiedToast(false), 2500);
  ...
  const copyEmailToClipboard = async () => {
    try {
      ...
      // Clipboard may be blocked; avoid throwing to the console for UX
    }
  };
  ...
  return (
    <div className="home">
        ...
        <div className="hero-content">
          ...
          <div className="hero-text">
            ...
            <div className="cta-buttons">
              ...
              <button
                type="button"
                className="social-link email-copy-button"
      ...
      <div
        className={`clipboard-toast${showCopiedToast ? ' clipboard-toast--visible' : ''}`}
        role="status"
        aria-live="polite"
        aria-atomic="true"
